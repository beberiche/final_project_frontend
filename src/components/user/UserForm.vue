  ...
  <div>
    ...
    <div>
      ...
      <button
        @click="signUpUser"
        v-else
        :disabled="!(idcheck && pwcheck && namecheck && agecheck)"
      >
        회원가입
      </button>
...
export default {
  ...
  mounted() {
    ...
    password.addEventListener("keyup", (e) => {
      ...
      console.log("pwcheck : ", this.pwcheck);
      console.log(this.idcheck, this.pwcheck, this.namecheck, this.agecheck);
      console.log(
        "check : ",
        this.idcheck && this.pwcheck && this.namecheck && this.agecheck
      );
    });
  },
};
